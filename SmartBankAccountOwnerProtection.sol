...
contract SmartBankAccount {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Only the bank owner can perform this transaction");
        // it's the account with which the contract is deployed
        _;
    }
    ...
    function getBalanceBank(address userAddress) public view onlyOwner returns(uint) {
